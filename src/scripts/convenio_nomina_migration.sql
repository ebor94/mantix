...
-- created_at/updated_at son NOT NULL sin default en la tabla real: sin
-- incluirlos, este INSERT falla con ER_NO_DEFAULT_FOR_FIELD (detectado en la
-- primera corrida contra producción).
