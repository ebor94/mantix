...
SELECT * FROM (
    ...
    SELECT
        ...
        ''                                                        AS \`DIRECCION \`,
        ''                                                        AS \`DIVIPOLA  \`,
        CASE WHEN a.diferenteAlContratante = 1 THEN '' ELSE ${TIPO_DOC('a.tipoDocumento')} END AS \`TIPO DOCUMENTO RELACIONADO\`,
        CASE WHEN a.diferenteAlContratante = 1 THEN '' ELSE a.numeroDocumento END AS \`NUMERO DOCUMENTO RELACIONADO\`,
        ''                                                        AS \`COD. PARIENTE\`,
