<!-- ============================================ -->
<!-- src/components/common/Sidebar.vue - RESPONSIVE -->
<!-- ============================================ -->
<template>
  <div
    :class="[
      'fixed inset-y-0 left-0 z-40 flex flex-col transition-all duration-300',
      // En móvil: ocultar completamente cuando collapsed
      // En desktop: mostrar versión reducida
      {
        '-translate-x-full lg:translate-x-0': isCollapsed,
    ...
    <div class="flex flex-col h-full bg-gradient-to-b from-primary-500 to-primary-700 text-white shadow-2xl">
      ...
      <div class="flex items-center justify-between px-4 py-6 border-b border-primary-600/30">
        <div class="flex items-center space-x-3">
          <div class="h-10 w-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div v-show="!isCollapsed || !isDesktop" class="transition-opacity duration-300">
           ...
           <a @click="navigateTo(item.path)"
            :class="[
              ...
              isActive 
                ...
                : 'hover:bg-white/10',
              (isCollapsed && isDesktop) ? 'justify-center' : 'space-x-3'
            ]"
          >
      ...
      <div class="px-4 py-4 border-t border-primary-600/30">
        <div class="flex items-center space-x-3">
          ...
          <div v-show="!isCollapsed || !isDesktop" class="flex-1 min-w-0 transition-opacity duration-300">
...
const menuItems = computed(() => [
  ...
  { name: 'Requisitos', path: '/requisitos', icon: DocumentTextIcon },
])
